...
let wordArray = []
let words = ['colonel', 'epitome','nauseous', 'inundate', 'uncanny', 'acommodate', 'miniscule', 'fuchsia', 'zucchini', 'spaghetti', 'austin', 'asthma', 'paradigm', 'pneumonia', 'sapphire', 'aquamarine', 'aphrodite', 'nightmare']
