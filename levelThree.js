...
let wordArray = []
let words = ['colonel', 'epitome','nauseous', 'worcestershire', 'inundate', 'uncanny', 'acommodate', 'miniscule', 'fuchsia', 'zucchini', 'spaghetti', 'austin', 'asthma', 'paradigm', 'pneumonia', 'sapphire', 'aquamarine', 'aphrodite', '']
